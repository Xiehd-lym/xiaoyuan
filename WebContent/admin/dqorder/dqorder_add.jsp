		...
		<div>
			<ol class="breadcrumb">
				<li><span class="glyphicon glyphicon-home"></span>&nbsp;<a
					href="#">主页</a></li>
				<li class="active">代取件信息添加</li>
			</ol>
		</div>
			<form action="<%=path %>/dqorder/save.action" name="formAdd" method="post">
				  <table class="table table-hover  table-bordered table-striped">
						<tr>
							<th colspan="4">&nbsp;添加代取件&nbsp;</td>
						</tr>
						    <tr>
							    <th width="50%">
							         快递编号
						    ...
						    <tr>
							    ...
							    <td width="50%">
							        	<input type="text" id="username" name="username" value="${sessionScope.user.realname }"/>
							    </td>
								</tr>	
						    <tr>
							    <th width="50%">
							    ...
							    <td width="50%">
							        	<input type="text" id="userphone" name="userphone" value="${sessionScope.user.tel }"/>
							    </td>
								</tr>	
						    <tr>
							    <th width="50%">
