				  ...
				  <table class="table table-hover  table-bordered table-striped">
						<tr>
						    ...
						    <tr>
							    ...
							    <td width="50%">
							        	<input type="text" id="yname" name="yname" readonly="readonly" value="${requestScope.bean.yname}" />
							    </td>
								</tr>	
						    <tr>
							    <th width="50%">
							    ...
							    <td width="50%">
							        	<input type="text" id="yphone" name="yphone" readonly="readonly" value="${requestScope.bean.yphone}" />
							    </td>
								</tr>	
						    <tr>
							    <th width="50%">
							    ...
							    <td width="50%">
							        	<input type="text" id="pingjia" name="pingjia" readonly="readonly" value="${requestScope.bean.pingjia}" />
							    </td>
								</tr>	
										    <tr>
							    <th width="50%">
							    ...
							    <td width="50%">
							        	<input type="text" id="pingfen2" name="pingfen2" value="${requestScope.bean.pingfen2}" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"/>
							    </td>
								</tr>	
						...
						<tr>
						    ...
						    <td width="50%">
						    	...
						    	<input type="hidden" id="yid" name="yid" value="${requestScope.bean.yid}"/>
