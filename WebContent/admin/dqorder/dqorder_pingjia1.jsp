				  ...
				  <table class="table table-hover  table-bordered table-striped">
						<tr>
						    ...
						    <tr>
							    ...
							    <td width="50%">
							        	<input type="text" id="pingfen" name="pingfen" value="${requestScope.bean.pingfen}" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"/>
							    </td>
								</tr>										
						    <tr>
							    <th width="50%">
