		...
		<div>
			<ol class="breadcrumb">
				<li><span class="glyphicon glyphicon-home"></span>&nbsp;<a
					href="#">主页</a></li>
				<li class="active">快递订单信息修改</li>
			</ol>
		</div>
					<form action="<%=path %>/order/update.action" name="formAdd" method="post">
				  <table class="table table-hover  table-bordered table-striped">
						<tr>
							<th colspan="2">&nbsp;修改快递订单&nbsp;</td>
						</tr>
						    <tr>
							    <th width="50%">
							         快递编号
						...
						<tr>
						    ...
						    <td width="50%">
						    	...
						    	<input type="hidden" id="yuangongid" name="yuangongid" value="${requestScope.bean.yuangongid}"/>
