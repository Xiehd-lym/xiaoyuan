	...
	<head>
		...
		<script language="javascript">
	       function check()
	       {
			          ...
			          {
			             alert("请输入职务");return false;
			          }
			          if(document.formAdd.xueli.value=="")
			          {
			             alert("请输入学历");return false;
			          }
		...
		<div>
			<ol class="breadcrumb">
				...
				<li class="active">用户信息修改</li>
					...
					<form action="<%=path %>/yuangong/update.action" name="formAdd" method="post">
				  <table class="table table-hover  table-bordered table-striped">
						<tr>
						    ...
						    <tr>
							    ...
							    <td width="50%">
							        	<input type="text" id="zhiwei" name="zhiwei" value="${requestScope.bean.zhiwei}" />
							    </td>
								</tr>	
						    <tr>
							    <th width="50%">
							    ...
							    <td width="50%">
							        	<input type="text" id="xueli" name="xueli" value="${requestScope.bean.xueli}" />
							    </td>
								</tr>	
						    <tr>
							    <th width="50%">
