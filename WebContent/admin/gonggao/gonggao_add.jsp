		...
		<div>
			<ol class="breadcrumb">
				<li><span class="glyphicon glyphicon-home"></span>&nbsp;<a
					href="#">主页</a></li>
				<li class="active">公告信息信息添加</li>
			</ol>
		</div>
			<form action="<%=path %>/gonggao/save.action" name="formAdd" method="post">
				  <table class="table table-hover  table-bordered table-striped">
						<tr>
						    ...
						    <tr>
							    ...
							    <td width="50%">
							        	<input type="text" id="neirong" name="neirong" />
							    </td>
								</tr>	
						    <tr>
							    <th width="50%">
						    ...
						    <tr>
							    ...
							    <td width="50%">
							        	<input type="text" id="type" name="type" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"/>
							    </td>
								</tr>	
						<tr>
						    <th width="50%">
